...
func NewRTPMuxer(encoder *EncodeContext) *MuxContext {
	c := &MuxContext{
		packet:  NewAVPacket(),
		encoder: encoder,
...
func (c *MuxContext) CopyToTracks(sid string, trackCh chan *webrtc.TrackLocalStaticRTP) error {
	...
	dial, _ := net.DialUDP("udp", nil, &net.UDPAddr{IP: net.IPv4(127,0,0,1), Port: 5002})
...
func (c *MuxContext) RTPCodecParameters() ([]*webrtc.RTPCodecParameters, error) {
